...
- [ ] **Step 1: Iniciar o git e gerar o template em pasta temporária (a pasta do projeto já tem `src/` e `docs/`, que o `create-expo-app` trataria como conflito)**
...
- [ ] **Step 2: Copiar só o que interessa (sem `App.tsx`/`index.ts`, que o Router substitui)**
...
- [ ] **Step 3: Instalar dependências (versões fixadas pelo `expo install` para o SDK 57)**
...
- [ ] **Step 4: Ajustar `package.json` (entry do Router e scripts)**
...
- [ ] **Step 5: `tsconfig.json` com strict e alias**
...
- [ ] **Step 6: `app.config.ts` mínimo (o completo vem na Task 9) e remover `app.json`**
...
- [ ] **Step 7: Rotas placeholder para o bundle existir**
...
- [ ] **Step 9: Teste de fumaça (prova que o preset RN + alias funcionam)**
