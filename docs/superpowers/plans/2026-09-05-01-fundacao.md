...
- [ ] **Step 1: Teste que falha — todo `FontFace` precisa de um TTF em `assets/fonts`**
...
- [ ] **Step 4: Tokens, tipografia, fontes e strings**
...
- [ ] **Step 5: Registrar as fontes no `app.config.ts`**
