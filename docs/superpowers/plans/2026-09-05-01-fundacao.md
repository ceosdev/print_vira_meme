...
- [x] **Step 4: Implementar `src/utils/templateEngine.ts`**
...
- [x] **Step 3: Implementar `src/utils/imageTransform.ts`**
...
- [x] **Step 4: Rodar o teste, typecheck e commit**
...
- [x] **Step 4: Implementar os stores**
...
- [x] **Step 5: Rodar os testes, typecheck e commit**
...
- [x] **Step 5: Rodar, typecheck e commit**
...
- [x] **Step 4: Implementar os mocks e o registro**
...
- [x] **Step 1: `app.config.ts` completo**
...
- [x] **Step 2: Placeholder reutilizável e rotas**
...
- [x] **Step 3: Atualizar o teste de fumaça**
...
- [x] **Step 4: Verificar tudo, inclusive bundle e doctor**
...
- [x] **Step 6: Entrega ao Carlos — rodar no Expo Go**
...
**Tasks 5–9:** sem desvios de código. `expo-doctor` exigiu `react-native-worklets` como dependência direta (peer do Reanimated 4) — instalado com `npx expo install react-native-worklets`. Estado final do plano: 11 suítes / 76 testes, `tsc --noEmit` limpo, `validate:catalog` OK, `expo export` gera o bundle Android, `expo-doctor` 21/21.
